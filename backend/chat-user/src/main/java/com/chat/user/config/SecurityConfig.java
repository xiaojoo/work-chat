...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // 只能由 chat-gateway / 其他服务用短期内部令牌调用
                .requestMatchers(
    ...
    /**
     * 控制器上的 @CrossOrigin 救不了预检：OPTIONS 不带令牌，会先被安全链挡掉。
     * 桌面壳的 app://chat 也算一个来源，所以按 pattern 放开；令牌走 Authorization 头、
     * 不依赖 cookie，因此不需要 allowCredentials。
     */
    @Bean
